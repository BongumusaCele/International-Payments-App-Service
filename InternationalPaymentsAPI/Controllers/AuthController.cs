...
namespace InternationalPaymentsAPI.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public async Task<IActionResult> Login(LoginDto dto)
        {
            ...
            string suppliedPassword = dto.GetPassword();
            if (string.IsNullOrWhiteSpace(suppliedPassword))
            {
            ...
            if (!PasswordHelper.VerifyPassword(suppliedPassword, customer.password_Hash, out bool needsRehash))
            {
            ...
            if (needsRehash)
            {
                customer.password_Hash = PasswordHelper.HashPassword(suppliedPassword);
            }
